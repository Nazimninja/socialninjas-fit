...
import { confirmSheet, onboardingWizardSheet, exploreProgramsSheet, athleteProfileSheet, weeklyCheckinSheet, appGuideSheet, importFromApp } from '../sheets.jsx'
  ...
  return <div className="narrow">
    ...
    {!MOBILE && <Section title={t('Tip')}>
      <Row icon="lightbulb" iconTint="var(--yellow)"
        ...
        subtitle={t('to install Fit Ninja as a full-screen app.') + ' ' + (user ? t('Your data syncs with your profile — sign in anywhere to see it.') : t('Guest data stays on this device — export a backup now and then!'))} />
    </Section>}
  ...
  return <>
    <Section
      ...
      footer={on && S.reminder?.on
        ...
        : null}
    >
      <Row icon="bell" iconTint="var(--red)" title={t('Push notifications')} subtitle={t('Rest-timer alerts, even if Fit Ninja is closed.')}>
