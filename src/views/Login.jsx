  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', marginBottom: '10px' }}>
        <div
          style={{
            ...
            boxShadow: '0 0 24px rgba(56, 189, 248, 0.45), inset 0 0 12px rgba(56, 189, 248, 0.25)',
            display: 'flex',
            alignItems: 'center',
        ...
        >
          <img
            ...
            style={{
              width: '44px',
              height: '44px',
              filter: 'drop-shadow(0 0 10px rgba(56,189,248,0.9)) brightness(1.2)',
              objectFit: 'contain',
              display: 'block'
            }}
          />
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', marginBottom: '2px' }}>
        <h1 style={{ fontSize: '26px', fontWeight: '900', letterSpacing: '-0.8px', margin: 0, color: '#ffffff' }}>
