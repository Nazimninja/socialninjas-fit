...
export default function Login() {
  ...
  return (
    <div className="narrow" style={wrap}>
      {head}
      <div className="muted" style={{ marginBottom: 28, fontSize: 14 }}>
        Elite Workouts, 1,324+ Animated Exercises & AI Nutrition
      </div>
      {webauthnOK() ? (
        <>
        ...
        <div className="card small muted" style={{ textAlign: 'left' }}>
          {t("This browser doesn't support passkeys — you can still use Fit Ninja locally on this device.")}
        </div>
      )}
