...
var EXERCISES = {
  ...
  lat_pulldown: {n:'Lat pulldown (wide grip)',b:'pull',ytId:'EUIri47Epcg',muscles:['Lats','Biceps','Rear delts'],cues:['Lean slightly back, chest up','Pull bar to upper chest — not behind neck','Squeeze shoulder blades at bottom','Control the return — don\'t let bar fly up','Feel the lat stretch at the top']},
...
var ASSESS_STEPS = [
  ...
  {q:'What equipment do you have?',sub:'List what you have (e.g., Pull-up bar, Kettlebells, 5kg dumbbells) or type "Gym Membership" if you go to a gym.',type:'text',key:'equipment',placeholder:'e.g. Dumbbells, Resistance bands'},
